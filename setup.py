...
setup(
    name='tapioca-youtube',
    version=get_version(package),
    description='youtube API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/victorcarrico/tapioca-youtube',
    packages=[
        'tapioca_youtube',
    ],
    package_dir={'tapioca_youtube': 'tapioca_youtube'},
